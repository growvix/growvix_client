  ...
  return (
    <ScrollArea className="h-svh">
      <SidebarProvider>
        <AppSidebar />
        <SidebarInset>
          <header className="sticky backdrop-blur-[5px] top-0 z-50 bg-white/5 flex h-12 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 mb-1">
